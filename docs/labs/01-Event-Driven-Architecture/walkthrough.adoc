...
. Open the link:{openshift-host}/k8s/ns/{namespace}/deployments/events[Events Deployment, window="_blank"], and link the recently created secret values as environment variables.
+
